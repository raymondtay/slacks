...
class FakeGetAllUsersWithPaginationHttpService extends HttpService {
  import cats.data.Kleisli, cats.implicits._
  import ContentTypes._
  import scala.concurrent.Future
  var state = 0 /* we are expecting the test to make 2 calls */
  val jsonData = List("""
    {"ok":true,
     "offset":"U0483ASQP",
     "members":[
       {"id":"USLACKBOT","team_id":"T024Z5MQM","name":"slackbot","deleted":false,"color":"757575","real_name":"slackbot","tz":null,"tz_label":"Pacific Standard Time","tz_offset":-28800,"profile":{"first_name":"slackbot","last_name":"","image_24":"https:\/\/a.slack-edge.com\/0180\/img\/slackbot_24.png","image_32":"https:\/\/a.slack-edge.com\/41b0a\/img\/plugins\/slackbot\/service_32.png","image_48":"https:\/\/a.slack-edge.com\/41b0a\/img\/plugins\/slackbot\/service_48.png","image_72":"https:\/\/a.slack-edge.com\/0180\/img\/slackbot_72.png","image_192":"https:\/\/a.slack-edge.com\/66f9\/img\/slackbot_192.png","image_512":"https:\/\/a.slack-edge.com\/1801\/img\/slackbot_512.png","avatar_hash":"sv1444671949","always_active":true,"display_name":"slackbot","real_name":"slackbot","real_name_normalized":"slackbot","display_name_normalized":"slackbot","fields":null,"team":"T024Z5MQM"},"is_admin":false,"is_owner":false,"is_primary_owner":false,"is_restricted":false,"is_ultra_restricted":false,"is_bot":false,"updated":0,"is_app_user":false},
       {"id":"U024Z5MQP","team_id":"T024Z5MQM","name":"veron","deleted":true,"profile":{"first_name":"April","last_name":"Ng","image_24":"https:\/\/avatars.slack-edge.com\/2014-02-06\/2169203855_24.jpg","image_32":"https:\/\/avatars.slack-edge.com\/2014-02-06\/2169203855_32.jpg","image_48":"https:\/\/avatars.slack-edge.com\/2014-02-06\/2169203855_48.jpg","image_72":"https:\/\/avatars.slack-edge.com\/2014-02-06\/2169203855_72.jpg","image_192":"https:\/\/avatars.slack-edge.com\/2014-02-06\/2169203855_192.jpg","image_original":"https:\/\/avatars.slack-edge.com\/2014-02-06\/2169203855_original.jpg","skype":"veronism","phone":" 9068 1341","title":"Product designer","avatar_hash":"OS2169203855","real_name":"April Ng","display_name":"veron","real_name_normalized":"April Ng","display_name_normalized":"veron","team":"T024Z5MQM"},"is_bot":false,"updated":1504244239,"is_app_user":false}
    ],
    "cache_ts":1513299076,
    "response_metadata":{"next_cursor":"dummy_cursor_value"}}""",
    """
    {"ok":true,
     "offset":"U0483ASQP",
     "members":[
  ...
  override def makeSingleRequest(implicit http: HttpExt, akkaMat: ActorMaterializer) = Kleisli{ 
    (_uri: String) ⇒ 
      val dataToBeReturned = (state == 0) match {
        case true ⇒ jsonData.head
        case _ ⇒ jsonData.tail.head
      }
      state += 1
     Future.successful(
        HttpResponse(entity = HttpEntity(`application/json`, dataToBeReturned))
      )
  }
}

class FakeGetAllUsersWithoutPaginationHttpService extends HttpService {
  import cats.data.Kleisli, cats.implicits._
  import ContentTypes._
  import scala.concurrent.Future
  ...
  val jsonData = """
    {"ok":true,
     "offset":"U0483ASQP",
     "members":[
       {"id":"USLACKBOT","team_id":"T024Z5MQM","name":"slackbot","deleted":false,"color":"757575",
        "real_name":"slackbot","tz":null,"tz_label":"Pacific Standard Time","tz_offset":-28800,
        "profile":{"first_name":"slackbot","last_name":"","image_24":"https:\/\/a.slack-edge.com\/0180\/img\/slackbot_24.png","image_32":"https:\/\/a.slack-edge.com\/41b0a\/img\/plugins\/slackbot\/service_32.png","image_48":"https:\/\/a.slack-edge.com\/41b0a\/img\/plugins\/slackbot\/service_48.png","image_72":"https:\/\/a.slack-edge.com\/0180\/img\/slackbot_72.png","image_192":"https:\/\/a.slack-edge.com\/66f9\/img\/slackbot_192.png","image_512":"https:\/\/a.slack-edge.com\/1801\/img\/slackbot_512.png","avatar_hash":"sv1444671949","always_active":true,"display_name":"slackbot","real_name":"slackbot","real_name_normalized":"slackbot","display_name_normalized":"slackbot","fields":null,"team":"T024Z5MQM"},
        "is_admin":false,"is_owner":false,"is_primary_owner":false,"is_restricted":false,
        "is_ultra_restricted":false,"is_bot":false,"updated":0,"is_app_user":false
       },
       {"id":"U024Z5MQP","team_id":"T024Z5MQM","name":"veron","deleted":true,"profile":{"first_name":"April","last_name":"Ng","image_24":"https:\/\/avatars.slack-edge.com\/2014-02-06\/2169203855_24.jpg","image_32":"https:\/\/avatars.slack-edge.com\/2014-02-06\/2169203855_32.jpg","image_48":"https:\/\/avatars.slack-edge.com\/2014-02-06\/2169203855_48.jpg","image_72":"https:\/\/avatars.slack-edge.com\/2014-02-06\/2169203855_72.jpg","image_192":"https:\/\/avatars.slack-edge.com\/2014-02-06\/2169203855_192.jpg","image_original":"https:\/\/avatars.slack-edge.com\/2014-02-06\/2169203855_original.jpg","skype":"veronism","phone":" 9068 1341","title":"Product designer","avatar_hash":"OS2169203855","real_name":"April Ng","display_name":"veron","real_name_normalized":"April Ng","display_name_normalized":"veron","team":"T024Z5MQM"},"is_bot":false,"updated":1504244239,"is_app_user":false}
    ],
    "cache_ts":1513299076,
...
class FakeChannelHistoryHttpService extends HttpService {
  ...
  override def makeSingleRequest(implicit http: HttpExt, akkaMat: ActorMaterializer) = Kleisli{ 
    (_uri: String) ⇒ 
        val jsonData = """
        {"ok":true,"messages":[{"text":"Hello. Another new user going by the name of Tracey Rountree (<mailto:tracey.rountree@netbooster.com|tracey.rountree@netbooster.com>) has passed through the donkey gates. We've also added them to Mailchimp's donkey Users list.  ","username":"Zapier","bot_id":"B0VD275DX","type":"message","subtype":"bot_message","ts":"1511157663.000229","reactions":[{"name":"tada","users":["U81GPG5HV"],"count":1}]},{"text":"","bot_id":"B139D7CUV","attachments":[{"fallback":"Tarun received a :bulb: 5 bonus from Paul: +5 @varun for completing all sprint tasks two weeks ago #speedofbusiness #trailblazer","text":"*+5* @varun for completing all sprint tasks two weeks ago #speedofbusiness #trailblazer\n<https:\/\/bonus.ly\/bonuses\/5a126c9475d0770b6382dbf8?utm_source=bonus.ly&amp;utm_medium=chat&amp;utm_campaign=slack#add-on|Add on to this bonus?>","pretext":"<https:\/\/bonus.ly\/bonuses\/5a126c9475d0770b6382dbf8?utm_source=bonus.ly&amp;utm_medium=chat&amp;utm_campaign=slack|Tarun received a bonus from Paul>","id":1,"color":"33CC66","mrkdwn_in":["text"]}],"type":"message","subtype":"bot_message","ts":"1511156887.000150"}],"has_more":false,"pin_count":27,"response_metadata":{"next_cursor":""}}"""
   ...
   "messages" : [
      {
      ...
      },
        {
           "type" : "message",
           "bot_id" : "B0VD275DX",
           "text" : "Hello. Another new user going by the name of Nancy Bernard (<mailto:nancy.bernard@mindshareworld.com|nancy.bernard@mindshareworld.com>) has passed through the donkey gates. We've also added them to Mailchimp's donkey Users list.  ",
           "username" : "Zapier",
        ...
        },
      {
         ...
         "text" : "<@U0PL0HUHG> commented on <@U024ZH7HL>’s file <https://donkey.slack.com/files/U024ZH7HL/F8CMV2GTH/image_uploaded_from_ios.jpg|Left is Singapore, right is China. The survey question is, \"I am comfortable with the idea of artificial intelligence/machines acting as...\">: you mean `waifu`?",
         "type" : "message",
      ...
      },
      {
         ...
         "subtype" : "file_comment",
         "type" : "message",
         "text" : "<@U4BUQR94L> commented on <@U024ZH7HL>’s file <https://donkey.slack.com/files/U024ZH7HL/F8CMV2GTH/image_uploaded_from_ios.jpg|Left is Singapore, right is China. The survey question is, \"I am comfortable with the idea of artificial intelligence/machines acting as...\">: .",
         "file" : {
            "thumb_360" : "https://files.slack.com/files-tmb/T024Z5MQM-F8CMV2GTH-779e71594f/image_uploaded_from_ios_360.jpg",
            "thumb_720_h" : 332,
            "thumb_960_w" : 960,
      ...
      },
      {
         ...
         "text" : "<@U3ACT6Z2P> commented on <@U024ZH7HL>’s file <https://donkey.slack.com/files/U024ZH7HL/F8CMV2GTH/image_uploaded_from_ios.jpg|Left is Singapore, right is China. The survey question is, \"I am comfortable with the idea of artificial intelligence/machines acting as...\">: oh yes, I thought it was cut off :neutral_face:",
         "file" : {
            "name" : "Image uploaded from iOS.jpg",
            "external_type" : "",
            "id" : "F8CMV2GTH",
      ...
      },
      {
         ...
         "text" : "<@U58LY38Q6> commented on <@U024ZH7HL>’s file <https://donkey.slack.com/files/U024ZH7HL/F8CMV2GTH/image_uploaded_from_ios.jpg|Left is Singapore, right is China. The survey question is, \"I am comfortable with the idea of artificial intelligence/machines acting as...\">: for each of the labels to the left I suppose",
         "type" : "message",
         "subtype" : "file_comment",
         "is_intro" : false,
         "comment" : {
      ...
      },
      {
         ...
         "text" : "<@U3ACT6Z2P> commented on <@U024ZH7HL>’s file <https://donkey.slack.com/files/U024ZH7HL/F8CMV2GTH/image_uploaded_from_ios.jpg|Left is Singapore, right is China. The survey question is, \"I am comfortable with the idea of artificial intelligence/machines acting as...\">: hm acting as what? :sweat_smile:",
         "file" : {
            "thumb_800_w" : 800,
            "title" : "Left is Singapore, right is China. The survey question is, \"I am comfortable with the idea of artificial intelligence/machines acting as...\"",
            "thumb_720_w" : 720,
      ...
      },
      {
         ...
         "text" : "<@U024ZH7HL> uploaded a file: <https://donkey.slack.com/files/U024ZH7HL/F8CMV2GTH/image_uploaded_from_ios.jpg|Left is Singapore, right is China. The survey question is, \"I am comfortable with the idea of artificial intelligence/machines acting as...\">",
         "user" : "U024ZH7HL",
         "subtype" : "file_share",
